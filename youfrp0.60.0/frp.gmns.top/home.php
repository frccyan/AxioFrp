...
<head>
    ...
    <title>YouFrp | 内网穿透 - 免费,高速,稳定,不限流量的端口映射工具。</title>
    <meta name="description"
        content="YouFrp是一款不限流量,免费高速且稳定的端口映射工具.为您提供免费的内网穿透功能。可以用于MC联机，远程桌面，远程共享，游戏联机等任何需要用到公网IP的地方。">
    <meta name="keywords" content="免费高速内网穿透工具,YouFrp,内网穿透,免费frp,免费内网穿透,frp,端口映射,不限流量的映射">
            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5 hover-scale">
                        <span class="sr-only">YouFrp</span>
                        <img class="h-8 w-auto float-animation" src="favicon.ico" alt="YouFrpLogo">
                    </a>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <a href="#" class="-m-1.5 p-1.5">
                            <span class="sr-only">YouFrp</span>
                            <img class="h-8 w-auto" src="favicon.ico" alt="YouFrpLogo">
                        </a>
            ...
            <div class="mx-auto mt-28 max-w-2xl py-32 sm:py-24 lg:py-24">
                ...
                <div class="text-center">
                    <h1 class="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl animate__animated animate__fadeInUp"
                        data-aos="fade-up">
                        <span class="text-gradient">YouFrp</span> | 端口映射
                    </h1>
    ...
    <div class="container px-5 py-24 mx-auto flex flex-wrap" id="info">
        <div class="flex w-full mb-20 flex-wrap" data-aos="fade-up">
            ...
            <p class="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base animate__animated animate__fadeInRight">
                游戏联机、远程桌面、建站、远程共享、文件传输、nas异地访问、远程控制智能家居、远程访问家里的路由器、自建游戏语音服务器等超多应用场景！无需公网IP、无需服务器、使用YouFrp将您的项目映射到公网！
            </p>
        </div>
    ...
    <div class="py-24 sm:py-32" data-aos="fade-up" id="features">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">YouFrp 提供了一系列强大的功能，满足您的各种内网穿透需求</p>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mt-16 space-y-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl hover-scale transition-all duration-300" data-aos="fade-up"
                    ...
                    <details class="group">
                        <summary class="flex justify-between items-center cursor-pointer">
                            <h3 class="text-lg font-semibold text-gray-900">YouFrp是免费的吗？</h3>
                        ...
                        <div class="mt-4 text-gray-600">
                            <p>YouFrp基础班是完全免费的，我们不收取任何费用，也不限制流量使用。免费版已经足够大多数场景使用，如果有更高的需求，我们还提供了付费计划，可以提供更好、更快、更稳定的内网穿透。
                            </p>
                        </div>
                    </details>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl hover-scale transition-all duration-300" data-aos="fade-up"
                    ...
                    <details class="group">
                        <summary class="flex justify-between items-center cursor-pointer">
                            <h3 class="text-lg font-semibold text-gray-900">YouFrp安全吗？</h3>
                            <span class="ml-2 text-indigo-600 group-open:hidden">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
    ...
    <div class="py-24 sm:py-32" data-aos="fade-up" id="dingjia">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <!-- 免费套餐 -->
                <div class="flex flex-col rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 hover:shadow-md transition-all duration-300"
                    data-aos="fade-up" data-aos-delay="100">
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900">免费套餐</h3>
                        <p class="mt-2 text-sm text-gray-600">适合临时个人项目</p>
                        <div class="mt-4 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-gray-900">¥0</span>
                            <span class="text-sm font-semibold leading-6 text-gray-600">/永久</span>
                        </div>
                        <a href="https://panel.ChmlFrp.cn"
                            class="mt-6 block w-full rounded-md bg-gray-100 px-3 py-2 text-center text-sm font-semibold text-gray-700 hover:bg-gray-200 transition-colors duration-300">开始使用</a>
                    </div>
                    <div class="flex flex-1 flex-col p-6 pt-0 border-t border-gray-200">
                        <ul class="flex-1 space-y-3">
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                </svg>
                                <span class="ml-3 text-sm text-gray-600">8Mbps限速</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">4条隧道</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">1条免费域名</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">不限流量</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <!-- 普通会员 -->
                <div class="flex flex-col rounded-xl bg-white shadow-md ring-1 ring-indigo-100 hover:shadow-lg transition-all duration-300"
                    data-aos="fade-up" data-aos-delay="150">
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900">普通会员</h3>
                        <p class="mt-2 text-sm text-gray-600">适合网站、ssh、远程桌面等服务</p>
                        <div class="mt-4 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-gray-900">¥8</span>
                            <span class="text-sm font-semibold leading-6 text-gray-600">/月</span>
                        </div>
                        <a href="https://panel.ChmlFrp.cn/shop/buy"
                            class="mt-6 block w-full rounded-md bg-indigo-100 px-3 py-2 text-center text-sm font-semibold text-indigo-700 hover:bg-indigo-200 transition-colors duration-300">升级套餐</a>
                    </div>
                    <div class="flex flex-1 flex-col p-6 pt-0 border-t border-gray-200">
                        <ul class="flex-1 space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="ml-3 text-sm text-gray-600">16Mbps限速</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">8条隧道</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">4条免费域名</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">会员节点权限</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <!-- 高级会员 -->
                <div class="flex flex-col rounded-xl bg-white shadow-lg ring-1 ring-indigo-200 transform hover:scale-[1.02] transition-all duration-300"
                    data-aos="fade-up" data-aos-delay="200">
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <h3 class="text-xl font-semibold text-gray-900">高级会员</h3>
                            <span
                                class="inline-flex items-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-xs font-medium text-indigo-800">推荐</span>
                        </div>
                        <p class="mt-2 text-sm text-gray-600">适合游戏联机、团队共享等服务</p>
                        <div class="mt-4 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-gray-900">¥12</span>
                            <span class="text-sm font-semibold leading-6 text-gray-600">/月</span>
                        </div>
                        <a href="https://panel.ChmlFrp.cn/shop/buy"
                            class="mt-6 block w-full rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-colors duration-300">升级套餐</a>
                    </div>
                    <div class="flex flex-1 flex-col p-6 pt-0 border-t border-gray-200">
                        <ul class="flex-1 space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="ml-3 text-sm text-gray-600">24Mbps限速</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">12条隧道</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">8条免费域名</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                            ...
                            <li class="flex items-start">
                                ...
                                <span class="ml-3 text-sm text-gray-600">不限制流量</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">官方技术支持</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="flex flex-col rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 hover:shadow-md transition-all duration-300"
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900">超级会员</h3>
                        <p class="mt-2 text-sm text-gray-600">适合文件传输等高带宽场景</p>
                        <div class="mt-4 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-gray-900">¥18</span>
                            <span class="text-sm font-semibold leading-6 text-gray-600">/月</span>
                        </div>
                        <a href="https://panel.ChmlFrp.cn/shop/buy"
                            class="mt-6 block w-full rounded-md bg-gray-800 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-800 transition-colors duration-300">升级套餐</a>
                    </div>
                    <div class="flex flex-1 flex-col p-6 pt-0 border-t border-gray-200">
                        <ul class="flex-1 space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="ml-3 text-sm text-gray-600">32Mbps限速</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">16条隧道</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <span class="ml-3 text-sm text-gray-600">16条免费域名</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="h-5 w-5 flex-shrink-0 text-indigo-600 mt-0.5" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
            ...
            <div class="mt-16 text-center" data-aos="fade-up">
                <p class="text-gray-500 text-sm">所有价格为最终支付价格，无手续费等隐藏费用。长期购买可享额外折扣，更多优惠请前往管理面板</p>
                <p class="mt-2 text-gray-500 text-sm">除此之外，还可以通过每日签到免费获取会员</p>
            </div>
        </div>
    </div>
            ...
            <div class="mt-16 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
                <div class="flex flex-col">
                    <div class="flex items-center">
                        ...
                        <span class="ml-4 text-sm text-gray-400">© 2025 YouFrp. All rights reserved.</span>
                        <span class="ml-4 text-sm text-gray-400">杜绝违法内容，请遵循法律法规和政府要求合规使用YouFrp。</span>
                    </div>
