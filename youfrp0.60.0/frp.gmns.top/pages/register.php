...
<html lang="zh_CN">
	<head>
		...
		<style type="text/css">
			...
			.verification-code .btn-send:hover {
					...
					<form method="POST" action="?action=register&page=register">
						...
						<div class="mb-3">
							...
							<div class="verification-code">
								<input type="number" class="form-control" name="verifycode" id="verifycode" placeholder="请输入验证码" required>
								<button type="button" class="btn btn-send" onclick="sendcode()">发送验证码</button>
							</div>
						</div>
						<?php endif; ?>
						...
						<div class="mb-3">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="invitecode" id="invitecode" placeholder="请输入邀请码" required>
							</div>
						</div>
						<?php endif; ?>
						...
						<button type="submit" class="btn btn-primary w-100 mb-3">注 册</button>
					</form>
				</div>
				
				<div class="auth-footer">
					<?php if($_config['register']['enable']): ?>
						<p class="mb-0">已有账号？<a href="?page=login">立即登录</a></p>
					<?php endif; ?>
				</div>
			</div>
		</div>
